...
expName = 'primary learning_Ashwini Tekwani AU2020196'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/ashwini/Downloads/data/data/primary learning_Ashwini Tekwani AU2020196_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('/Users/ashwini/Downloads/study_word file .xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('/Users/ashwini/Downloads/test file .xlsx'),
